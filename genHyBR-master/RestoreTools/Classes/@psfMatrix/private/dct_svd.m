...
%              smallest.
%
% 5/3/11 - Modification JC to accomodate rectangular images
%
...
% JC Modification
  P(1:n(1)-c(1)+1,1:n(2)-c(2)+1) = PSF(c(1):n(1),     c(2):n(2)       );
  P(1:n(1)-c(1)+1,1:n(2)-c(2)  ) = P(1:n(1)-c(1)+1,1:n(2)-c(2)  ) + PSF(c(1):n(1),  c(2)+1:n(2));
  P(1:n(1)-c(1),  1:n(2)-c(2)+1) = P(1:n(1)-c(1),  1:n(2)-c(2)+1) + PSF(c(1)+1:n,c(2):n(2)  );
  P(1:n(1)-c(1),  1:n(2)-c(2)  ) = P(1:n(1)-c(1),  1:n(2)-c(2)  ) + PSF(c(1)+1:n,c(2)+1:n(2));  
